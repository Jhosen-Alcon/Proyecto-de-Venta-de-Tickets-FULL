...
$pdf->Cell(25,8, 'Codigo Lugar','B',0,'C',0);
$pdf->Cell(35,8, 'Lugar','B',0,'C',0);
$pdf->Cell(30,8, 'Codigo Evento','B',0,'C',0);
$pdf->Cell(40,8, 'Nombre Evento','B',0,'C',0);
$pdf->Cell(50,8, 'Fecha evento','B',0,'C',0);
$pdf->Cell(10,8, 'Hora Evento ','B',1,'C',0);
   ...
   //$rows=$resultado->fetchAll(PDO::FETCH_ASSOC);
    ...
    while($row=$resultado->fetch_assoc()){
        ...
        $pdf->SetDrawColor(163, 134, 128);//color de linea  rgb
           ...
           $pdf->SetX(15);
           $pdf->Cell(25,8, $row['Id_Lugar'], 'B',0,'C',0);
           $pdf->Cell(35,8, $row['Lugar'], 'B',0,'C',0);
           $pdf->Cell(30,8, $row['Id_Evento'], 'B',0,'C',0);
           $pdf->Cell(40,8, $row['Nombre_Evento'], 'B',0,'C',0);
             $pdf->Cell(50,8, $row['Fecha'],'B',0,'C',0);
             $pdf->Cell(10,8, $row['Hora'],'B',1,'C',0);
        }
