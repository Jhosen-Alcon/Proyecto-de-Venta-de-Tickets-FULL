...
class PDF extends FPDF{
    ...
    $this->setXY(60,15);
    $this->Cell(100,8,'REPORTES DE EVENTOS',0,1,'C',0);
    $this->Ln(7);
    $this->SetX(32);
    ...
    $pdf->Cell(30,8, 'LUGAR',1,0, 'C',0);
    $pdf->Cell(35,8, 'FECHA','B',0,'C',0);
    $pdf->Cell(40,8, 'CI','B',1,'C',0);
    ...
    $pdf->SetDrawColor(163, 134, 128);//color de linea  rgb
       ...
       $pdf->Cell(50,8, $row['Nombre_Evento'], 'B',0,'C',0);
         ...
         $pdf->Cell(35,8, $row['Fecha_Hora'],'B',0,'C',0);
         $pdf->Cell(40,8, $row['CI'],'B',1,'C',0);
    }
