...
$(window).on('load', function() {
	...
	/* -----------------------------------
			  2. Sound Setup
	----------------------------------- */
	$('body').append('<audio loop autoplay volume="0" id="audio-player"><source src="multimedia/The Kid LAROI_ Justin Bieber - STAY (Official Video)(MP3_320K).mp3" type="audio/mpeg"></audio>');
